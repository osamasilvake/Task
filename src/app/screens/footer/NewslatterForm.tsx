	...
	<form className="pt-[75px] mx-auto sm:pl-3 xl:mx-0 xl:w-201">
		...
		<div className="flex flex-col items-center gap-4 pb-8 pt-2 sm:flex-row">
			<input
				...
				className="w-full rounded-401 outline-none border-2 focus:border-blue-600 bg-102 focus:bg-white px-7 py-3.5 placeholder:text-gray-500 placeholder:text-lg sm:pr-28 md:w-96 sm:py-4"
			/>
